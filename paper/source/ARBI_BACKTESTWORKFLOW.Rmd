...
library(png)
library(grid)
img <- readPNG("/home/riaz/projects/equity_analysis/paper/source/data/tearsheet_excerpt.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("/home/riaz/projects/equity_analysis/paper/source/data/cross_validation_excerpt.png")
grid.raster(img)
```
