...
1. Compaction: dropping useless data
2. Speed: training vs trading
3. Speed: parallel processing
4. Speed: read/write: feather
5. Memory: filtering and subsetting
...
```{r dataflow_diagram, evaluate = FALSE, echo = FALSE}
library(magrittr)
library(DiagrammeR)
library(tidyverse)
nodes <- c("Source 1",
