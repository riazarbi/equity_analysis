...
## Cross Validation - `5-cross_validate.R`


## Limitations and Weaknesses

- More comprehensive results reporting
- Implementation of LIVE
- Automated testing of dataset quality
- Collection of all tearsheets into a shiny app
- Piping pbo into shiny app

- Slow - in-memory will speed it up dramatically
- Loading ticker data - can be more compact
- Larger library of algorthms

- More realistic modelling of transaction costs and slippage
- Make data processing less opinionated - can consume other data structures as well.
- Decouple rebalancing heartbeat from trading heartbeat
